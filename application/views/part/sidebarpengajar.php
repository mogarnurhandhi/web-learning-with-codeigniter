...
<aside class="menu-sidebar d-none d-lg-block">
    <div class="logo">
        <a href="#">
            <img src="/e-learning/CoolAdmin-master/images/icon/edu_ease.png" alt="Cool Admin" />
        </a>
    </div>
...
<div class="page-container">
    ...
    <style>
        ...
        .header-wrap>.logo>img {
            max-width: 30%;
            /* Logo akan mengikuti lebar maksimal header-wrap */
            height: auto;
            /* Mencegah logo memperoleh tinggi yang tidak proporsional */
            margin-right: 10px;
        ...
        <div class="section__content section__content--p30">
            <div class="container-fluid">
                <div class="header-wrap">
                    <div class="logo">
                        <img src="/e-learning/CoolAdmin-master/images/icon/uny_mengajar.png" alt="Cool Admin" />
                    </div>
